...
class TermInputConnection extends BaseInputConnection {
    ...
    //T+{ ------------------------------------------------------------
    //T+ // Extracted class `TermInputConnection´ from `EmulatorView.onCreateInputConnection´.
    //T+ // I have *not* annotated all places where I had to introduce `mEmulatorView´ to access
    //T+ // `clearSpecialKeyStatus´, `mImeBuffer´, `mKeyListener´, `mTermSession´ and `setImeBuffer´.
    //T+ // TODO ThH: Improve encapsulation, `TermInputConnection´ accesses `mEmulatorView´.
