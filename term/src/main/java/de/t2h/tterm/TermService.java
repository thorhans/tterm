...
{
    //T-{ ------------------------------------------------------------
    //T- /* Parallels the value of START_STICKY on API Level >= 5 */
    //T- private static final int COMPAT_START_STICKY = 1;
    //T-} ------------------------------------------------------------

    private static final int RUNNING_NOTIFICATION = 1;

    //T-{ ------------------------------------------------------------
    //T- private ServiceForegroundCompat compat;
    //T-} ------------------------------------------------------------
    ...
    //T!{ ------------------------------------------------------------
    //T! /* This should be @Override if building with API Level >=5 */
    @Override
    //T! public int onStartCommand(Intent intent, int flags, int startId) { return COMPAT_START_STICKY; }
    ...
    public void onCreate() {
        ...
        //T+{ ------------------------------------------------------------
        // Sigh, `defValue´ means "default value".
        ...
        //T-{ ------------------------------------------------------------
        //T- compat = new ServiceForegroundCompat(this);
        //T-} ------------------------------------------------------------
        mTermSessions = new SessionList();

        /* Put the service in the foreground. */
        //T-{ ------------------------------------------------------------
        //T- Notification notification = new Notification(R.drawable.ic_stat_service_notification_icon,
        //T-   getText(R.string.service_notify_text), System.currentTimeMillis());
        //T- notification.flags |= Notification.FLAG_ONGOING_EVENT;
        //T-} ------------------------------------------------------------
        Intent notifyIntent = new Intent(this, Term.class);
        notifyIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        PendingIntent pendingIntent = PendingIntent.getActivity(this, 0, notifyIntent, 0);
        //T-{ ------------------------------------------------------------
        //T- notification.setLatestEventInfo(this, getText(R.string.application_terminal),
        //T-   getText(R.string.service_notify_text), pendingIntent);
        //T-} ------------------------------------------------------------
        ...
        //T!{ ------------------------------------------------------------
        //T!- compat.startForeground(RUNNING_NOTIFICATION, notification);
