...
//T-{ ------------------------------------------------------------
//T- import android.util.      FloatMath;
//T-} ------------------------------------------------------------
...
public class TextIcon
{
  ...
  public static Bitmap getTextIcon(String text, int color, int width, int height)
  {
    ...
    int     wBitmap= (int)W;
    //T!{ ------------------------------------------------------------
    //T! if(W<f) {wBitmap=(int)FloatMath.ceil(f); hBitmap=(int)FloatMath.ceil(H);}
    //T! else    {wBitmap=(int)FloatMath.ceil(W); hBitmap=(int)FloatMath.ceil(height*wBitmap/width);}
