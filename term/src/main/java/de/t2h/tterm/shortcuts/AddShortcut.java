...
//T!{ ------------------------------------------------------------
//T! import de.t2h.tterm.compat.AlertDialogCompat;
       ...
       extends    android.app.Activity
{
  ...
  void makeShortcut()
  {
    if(path==null) path="";
    //T!{ ------------------------------------------------------------
    //T! final AlertDialogCompat.Builder alert =
    //T!     AlertDialogCompat.newInstanceBuilder(context, AlertDialogCompat.THEME_HOLO_DARK);
    ...
    final ImageView img=new ImageView(context);
                    //T!{ ------------------------------------------------------------
                    //T! img.setImageResource(jackpal.androidterm.R.drawable.ic_launcher);
  ...
  void buildShortcut(
    ...
    {
      //T-{ ------------------------------------------------------------
      //T- // Apply workarounds for SecureRandom bugs in Android < 4.4
      //T- PRNGFixes.apply();
      //T-} ------------------------------------------------------------
      ...
      Intent wrapper= new Intent();
             ...
             else
             {
               wrapper.putExtra(
                 ...
                 //T!{ ------------------------------------------------------------
                 //T! , Intent.ShortcutIconResource.fromContext(context, jackpal.androidterm.R.drawable.ic_launcher)
