...
public class TermSettings {
    ...
    private void readDefaultPrefs(Resources res) {
        ...
        mExtraKeysShown = Integer.parseInt(res.getString(R.string.pref_extrakeysshown_default));
        //T+} ------------------------------------------------------------
    ...
    public void readPrefs(SharedPreferences prefs) {
        ...
        //T+{ ------------------------------------------------------------
        mExtraKeySize = readIntPref(EXTRAKEYSIZE_KEY, mExtraKeySize, 36);
        mExtraKeysShown = readIntPref(EXTRAKEYSShOWN_KEY, mExtraKeysShown, 2);
        //T+} ------------------------------------------------------------
    ...
    //T+{ ------------------------------------------------------------
    public int getExtraKeySize() { return mExtraKeySize; }
    public int getExtraKeysShown() { return mExtraKeysShown; }
    //T+} ------------------------------------------------------------
