...
class EmulatorDebug {
    ...
    /** Set to true to log each character received from the remote process to the android log.
     *
     * <p>It makes it easier to debug some kinds of problems with emulating escape sequences and control
     * codes.</p>
     */
