...
class UnicodeTranscript {
    ...
    public static int charWidth(int codePoint) {
        ...
        if ((codePoint >= 0x1160 && codePoint <= 0x11FF) ||
            ...
            //T-{ ------------------------------------------------------------
            //T- if (AndroidCompat.SDK >= HANGUL_CONJOINING_MIN_SDK) {
            //T-} ------------------------------------------------------------
            ...
            //T-{ ------------------------------------------------------------
            //T- } else {
            //T-     /* Older versions of Android didn't compose Hangul jamo, but
            //T-      * instead rendered them as individual East Asian wide
            //T-      * characters (despite Unicode defining medial vowels and final
            //T-      * consonants as East Asian neutral/narrow).  Treat them as
            //T-      * width 2 characters to match the rendering. */
            //T-     return 2;
            //T- }
            //T-} ------------------------------------------------------------
        }
        if (Character.charCount(codePoint) == 1) {
            ...
            //T!{ ------------------------------------------------------------
            //T! switch (AndroidCharacterCompat.getEastAsianWidth((char) codePoint)) {
            switch (AndroidCharacter.getEastAsianWidth((char) codePoint)) {
            //T! case AndroidCharacterCompat.EAST_ASIAN_WIDTH_FULL_WIDTH:
            //T! case AndroidCharacterCompat.EAST_ASIAN_WIDTH_WIDE:
            //T!} ------------------------------------------------------------
